...
export function AuthPage() {
  ...
  const copy = useMemo(() => (locale === 'mn'
    ? {
        ...
        title: 'Мэдлэгээ нэг дор төвлөрүүл.',
        body: 'Дижитал нөөц, бүтээл, мэдлэгийн сангаа нэг платформ дээр удирдаж эхлээрэй.',
        signInTitle: 'Нэвтрэх',
        signInBody: 'Хадгалсан нөөц, сонгосон материал болон ажлын орчноо үргэлжлүүлнэ үү.',
        signUpTitle: 'Бүртгэл үүсгэх',
        signUpBody: 'Шинэ бүртгэл нээгээд өөрийн нөөц, файл, профайлаа EduBridge дээр байршуулж эхлээрэй.',
        signIn: 'Нэвтрэх',
        signUp: 'Бүртгүүлэх',
        email: 'Имэйл',
        password: 'Нууц үг',
        name: 'Нэр',
        role: 'Хэрэглэгчийн төрөл',
        student: 'Хэрэглэгч',
        instructor: 'Бүтээгч',
        switchToSignIn: 'Бүртгэлтэй юу? Нэвтрэх',
        switchToSignUp: 'Шинэ хэрэглэгч бол бүртгүүлэх',
        createPassword: 'Нууц үг үүсгэх',
        panelTitle: 'Суралц. Бүтээ. Хуваалц.',
        panelBody: 'EduBridge нь код, загвар, баримт бичиг, UI систем болон бусад digital resource-ийг нэгтгэдэг бүтэцтэй орчин.',
    ...
    : {
        ...
        panelTitle: 'Learn. Build. Share.',
        panelBody: 'EduBridge is a structured home for code, templates, documents, UI systems, and creator-ready digital resources.',
